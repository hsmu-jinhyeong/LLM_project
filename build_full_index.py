...
Usage:
    python build_full_index.py [--batch-size 32] [--output recipe_full.index]
...
from menu_bot.embedding_utils import get_embeddings_batch

# Default paths
DEFAULT_DATA_PATH = "data/TB_RECIPE_SEARCH_241226.csv"
DEFAULT_INDEX_PATH = "data/recipe_full.index"
